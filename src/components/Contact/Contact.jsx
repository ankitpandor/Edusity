...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "b9bd32b9-fd25-4387-b100-f3df371133fa");
    ...
    return (
        <div className='contact'>
            <div className="contact-col">
                ...
                <p>Feel free to erach out through form or find our contact 
                ...
                <ul>
                    ...
                    <li><img src={location_icon} alt="" />abcd</li>
                </ul>
            </div>
            <div className="contact-col">
                <form onSubmit={onSubmit} >
                    ...
                    <button type='Submit' className='btn dark-btn'>Submit Now <img src={white_arror} alt="" /></button>
                </form>
                <span>{result}</span>
            </div>
        </div>
